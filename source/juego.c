...
void crearMonedas(){
	...
	int i;
	int x = rand() % 224;
	int y = (rand() % 32*(personaje.estadisticas->nivActual->altura + 6)) - 32*(personaje.estadisticas->nivActual->altura); // Puede ir desde arriba del mapa (Número negativo) hasta y = 192
